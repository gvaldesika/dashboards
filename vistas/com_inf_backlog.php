...
$resu2 = BacklogControlador::ctrVerBacklogGrafico(7);
$ventaAdjud = BacklogControlador::ctrVerBackloVentaAdjudicada(7);
$ventasPeriodo = ComprobantesControlador::ctrObtenerIngresosPeriodo(date('Y-m-d', strtotime('-1 year')),date('Y-m-d'),7,2);
//$ventasPeriodo = ComprobantesControlador::ctrObtenerIngresosPeriodo(date('2020-01-01'),date('2020-12-31'),7,2);
$totalBacklog = 0;
...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <center><h4>UN Mineria - Industrial</h4></center>
            <br><br>
