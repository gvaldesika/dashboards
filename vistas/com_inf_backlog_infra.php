...
$resu2 = BacklogControlador::ctrVerBacklogGraficoInf(3);
$ventaAdjud = BacklogControlador::ctrVerBackloVentaAdjudicadaInf(3);
$ventasPeriodo = ComprobantesControlador::ctrObtenerIngresosPeriodo(date('Y-m-d', strtotime('-1 year')),date('Y-m-d'),3,2);
$totalBacklog = 0;
...
<div class="container">
    <div class="card">
        <div class="card-body">
            <center><h3>Backlog IKA (M$ clp)</h3></center>
            <br>
            <center><h4>UN Infraestructura</h4></center>
            <br><br>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <table class="table table-sm" >
                        ...
                        foreach (ParametrosApp::obtenerCCOUnInfraestructura() as $row)
                        {
