...
$resu2 = BacklogControlador::ctrVerBacklogGrafico(6);
$ventaAdjud = BacklogControlador::ctrVerBackloVentaAdjudicada(6);
$ventasPeriodo = ComprobantesControlador::ctrObtenerIngresosPeriodo(date('Y-m-d', strtotime('-1 year')),date('Y-m-d'),6,2);
$totalBacklog = 0;
...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <center><h4>UN Mineria</h4></center>
            <br><br>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <table class="table table-sm" >
                        ...
                        foreach (ParametrosApp::obtenerCCOUnMineria() as $row)
                        {
