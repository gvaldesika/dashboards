...
$ventasPeriodo = ComprobantesControlador::ctrObtenerIngresosPeriodo(date('Y-m-d', strtotime('-1 year')),date('Y-m-d'),null,2);
$totalBacklog = 0;
...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <center><h4>UN Mineria - Industrial - Infraestructura</h4></center>
            <br><br>
