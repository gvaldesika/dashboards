...
$listaMin = ComprobantesControlador::ctrObtenerIngresosAnualesMineria($fActual,2);
$budgetBaseMin = ComprobantesControlador::ctrObtenerPresupuestoUn($fActual,'Base','IKA Mineria');
$listaAcumuladoMin = ComprobantesControlador::ctrObtenerIngresosAnualesAcumuladoMineria($fActual,2);
$budgetBaseAcumuladoMin = ComprobantesControlador::ctrObtenerPresupuestoAcumuladoUn($fActual,'Base','IKA Mineria');
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <canvas id="bar-chart-mineria" width="800" height="450"></canvas>
                </div>
            </div>
            ...
            datasets: [
                {
                    ...
                    borderColor: "#77dd77",
                    yAxisID: 'right-y-axis',
                    data: [<?php echo $budgetBaseAcumuladoMin[0]['valor']?>,<?php echo $budgetBaseAcumuladoMin[1]['valor']?>,<?php echo $budgetBaseAcumuladoMin[2]['valor']?>,<?php echo $budgetBaseAcumuladoMin[3]['valor']?>,<?php echo $budgetBaseAcumuladoMin[4]['valor']?>,<?php echo $budgetBaseAcumuladoMin[5]['valor']?>,
                        <?php echo $budgetBaseAcumuladoMin[6]['valor']?>,<?php echo $budgetBaseAcumuladoMin[7]['valor']?>,<?php echo $budgetBaseAcumuladoMin[8]['valor']?>,<?php echo $budgetBaseAcumuladoMin[9]['valor']?>,<?php echo $budgetBaseAcumuladoMin[10]['valor']?>,<?php echo $budgetBaseAcumuladoMin[11]['valor']?>]
                },
                {
                    label: "Real Acumulado",
                    type: "line",
                    ...
                    borderColor: "#ff6666",
                    yAxisID: 'right-y-axis',
                    data: [<?php echo $listaAcumuladoMin[0]['valor']?>,<?php echo $listaAcumuladoMin[1]['valor']?>,<?php echo $listaAcumuladoMin[2]['valor']?>,<?php echo $listaAcumuladoMin[3]['valor']?>,<?php echo $listaAcumuladoMin[4]['valor']?>,<?php echo $listaAcumuladoMin[5]['valor']?>,
                        <?php echo $listaAcumuladoMin[6]['valor']?>,<?php echo $listaAcumuladoMin[7]['valor']?>,<?php echo $listaAcumuladoMin[8]['valor']?>,<?php echo $listaAcumuladoMin[9]['valor']?>,<?php echo $listaAcumuladoMin[10]['valor']?>,<?php echo $listaAcumuladoMin[11]['valor']?>]
                }
                ,{
                    label: 'UN  Mineria',
                    yAxisID: 'left-y-axis',
