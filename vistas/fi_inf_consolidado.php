        ...
        <div class="card">
            <div class="card-body">
                ...
                if(isset($_POST['btnMostrar']))
                {
                    ...
                    switch ($origen)
                    {
                        case 1: //Data en vivo
                            ...
                            $informe = FinancieroControlador::ctrVerConsolidado($ano,[525,526,527,528,529,530,531,532,533,534,535,536,537,538,539,540,541],$listaEmpresasEugcom);
                            break;

                        case 2: // Data publicada
                            $informe = ResultadosControlador::ctrObtenerInformeAnualColumna(1,$ano); // No Implementado (Pruebas)
                            break;
                    }
                ...
                }else
                {
                    ...
                    $_SESSION['origenConsolidado'] = 'Dato en vivo';
                    $_SESSION['anoConsolidado'] = $ano;
                    $informe = FinancieroControlador::ctrVerConsolidado($ano,[30,50,525,526,527,528,529,530,531,532,533,534,535,536,537,538,539,540,541],$listaEmpresasEugcom);
...
<form method="post">
                ...
                <table class="table table-sm">
                    ...
                    <tr>
                        <th scope="col" colspan="14"><center>RESULTADO CONSOLIDADOS MENSUALES - PERIODO ENERO <?php echo $_SESSION['anoConsolidado']; ?> / DICIEMBRE <?php echo $_SESSION['anoConsolidado']; ?></center></th>
                    </tr>
                    ...
                    foreach ($informe['Ventas / Costo Directo'] as $row)
                    {
                        ...
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][1]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][2]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][3]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][4]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][5]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][6]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][7]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][8]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][9]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][10]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][11]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][12]).'</td>';
                        echo '<td>'.formateaNumeroMillones($informe['Gastos de Adm. y Ventas'][0][13]).'</td>';
                        echo '</tr>';
                    ...
                    foreach ($informe['Otros Egresos'] as $row)
                    {
                        echo '<tr> ';
                        echo '<td><b>Otros Egresos</b></td>';
                        echo '<td>'.formateaNumeroMillones($row[1]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[2]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[3]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[4]).'</td>';
                    ...
                    {
                        echo '<tr> ';
                        echo '<td><b>Gastos Financieros</b></td>';
                        echo '<td>'.formateaNumeroMillones($row[1]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[2]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[3]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[4]).'</td>';
                    ...
                    {
                        echo '<tr> ';
                        echo '<td><b>Correc. Monetaria</b></td>';
                        echo '<td>'.formateaNumeroMillones($row[1]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[2]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[3]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[4]).'</td>';
                    ...
                    foreach ($informe['Resultado No Operacional'] as $row)
                    {
                        echo '<tr class="table-active"> ';
                        echo '<td><b>Resultado No Operacional</b></td>';
                        echo '<td><b>'.formateaNumeroMillones($row[1]).'</b></td>';
                        echo '<td><b>'.formateaNumeroMillones($row[2]).'</b></td>';
                        echo '<td><b>'.formateaNumeroMillones($row[3]).'</b></td>';
                        echo '<td><b>'.formateaNumeroMillones($row[4]).'</b></td>';
                    ...
                    foreach ($informe['Resultado Antes de Impuestos'] as $row)
                    {
                        echo '<tr> ';
                        echo '<td><b>Resultado Antes de Impuestos</b></td>';
                        echo '<td>'.formateaNumeroMillones($row[1]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[2]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[3]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[4]).'</td>';
                    ...
                    foreach ($informe['Resultado Desp. Impuestos'] as $row)
                    {
                        echo '<tr class="table-active"> ';
                        echo '<td><b>Resultado Desp. Impuestos</b></td>';
                        echo '<td><b>'.formateaNumeroMillones($row[1]).'</b></td>';
                        echo '<td><b>'.formateaNumeroMillones($row[2]).'</b></td>';
                        echo '<td><b>'.formateaNumeroMillones($row[3]).'</b></td>';
                        echo '<td><b>'.formateaNumeroMillones($row[4]).'</b></td>';
                    ...
                    foreach ($informe['EBITDA'] as $row)
                    {
                        echo '<tr> ';
                        echo '<td><b>EBITDA</b></td>';
                        echo '<td>'.formateaNumeroMillones($row[1]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[2]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[3]).'</td>';
                        echo '<td>'.formateaNumeroMillones($row[4]).'</td>';
                    ...
                    foreach ($informe['% EBITDA / Ingresos (%)'] as $row)
                    {
                        echo '<tr> ';
                        echo '<td><b>% EBITDA / Ingresos (%)</b></td>';
                        echo '<td>'.formateaPorcentajes($row[1]).'</td>';
                        echo '<td>'.formateaPorcentajes($row[2]).'</td>';
                        echo '<td>'.formateaPorcentajes($row[3]).'</td>';
                        echo '<td>'.formateaPorcentajes($row[4]).'</td>';
