...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <center><h3>Informe Consolidado (Industrial+Minería)</h3></center><br>
                <?php
                ...
                if(isset($_POST['btnMostrar']))
                {
                    ...
                    switch ($origen)
                    {
                        case 1: //Data en vivo
                            ...
                            $informe = FinancieroControlador::ctrVerConsolidado($ano,[525,526,527,528,529,530,532,533,534,536],$listaEmpresasEugcom);
                            break;
...
<form method="post">
                ...
                <table class="table table-sm">
                    ...
                    <tr>
                        <th scope="col" colspan="14"><center>RESULTADO CONSOLIDADOS MENSUALES (INDUSTRIAL - MINERÍA) - PERIODO ENERO <?php echo $_SESSION['anoConsolidado']; ?> / DICIEMBRE <?php echo $_SESSION['anoConsolidado']; ?></center></th>
                    </tr>
