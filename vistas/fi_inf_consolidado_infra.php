...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <center><h3>Informe Consolidado (Infraestructura)</h3></center><br>
                <?php
                ...
                if(isset($_POST['btnMostrar']))
                {
                    ...
                    switch ($origen)
                    {
                        case 1: //Data en vivo
                            ...
                            $informe = FinancieroControlador::ctrVerConsolidado($ano,[535,537,538,539,540,541],$listaEmpresasEugcom);
                            break;
...
<form method="post">
                ...
                <table class="table table-sm">
                    ...
                    <tr>
                        <th scope="col" colspan="14"><center>RESULTADO CONSOLIDADOS MENSUALES (INFRAESTRUCTURA) - PERIODO ENERO <?php echo $_SESSION['anoConsolidado']; ?> / DICIEMBRE <?php echo $_SESSION['anoConsolidado']; ?></center></th>
                    </tr>
