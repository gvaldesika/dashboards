...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <center><h3>Informe Consolidado (Minería)</h3></center><br>
                <?php
...
<form method="post">
                ...
                <table class="table table-sm">
                    ...
                    <tr>
                        <th scope="col" colspan="14"><center>RESULTADO CONSOLIDADOS MENSUALES (MINERÍA) - PERIODO ENERO <?php echo $_SESSION['anoConsolidado']; ?> / DICIEMBRE <?php echo $_SESSION['anoConsolidado']; ?></center></th>
                    </tr>
