...
if (isset($_POST['btnFiltrar']))
{
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    }else
    {
        ...
        $informe = FinancieroControlador::ctrVerGerenciaActivos($ano,[50,30],$listaEmpresasEugcom);
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <center><h3>Resultado Gerencia Activos</h3></center><br>
                ...
                <table class="table table-sm">
                    ...
                    <tr>
                        <th scope="col" colspan="14" class="text-center">RESULTADO GERENCIA ACTIVOS (CCO 50/30) - <?php echo 'Periodo: '.$ano ?></th>
